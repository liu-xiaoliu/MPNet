...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_freq', type=int, default=96, help='frequency of showing training results on screen')
        ...
        # parser.add_argument('--epoch_count', type=int, default=90)
